...
public class MyTunes 
{
	...
	public static void main(String[] args) 
	{
		...
		//my test files
		//final String TESTFILE01 = "resources/IDtest.txt";	// Example test file for hashing based on IDs
		//final String TESTFILE02 = "resources/genreTest.txt"; // Example test file for hashing based on genres names
